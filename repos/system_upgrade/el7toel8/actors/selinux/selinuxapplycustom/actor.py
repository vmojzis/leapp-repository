    ...
    def process(self):
        ...
        for semodules in self.consume(SELinuxModules):
            ...
            for module in semodules.modules:
                ...
                try:
                    ...
                    self.log.warning("Error writing %s : %s", cil_filename, str(e.stderr))
                    continue
                ...
                try:
                    ...
                    self.log.warning("Error removing module file: %s", str(e.stderr))
        ...
        for custom in self.consume(SELinuxCustom):
            ...
            try:
                ...
                self.log.warning("Error writing SELinux customizations: %s", str(e.stderr))
            ...
            try:
                ...
                self.log.warning("Failed to remove temporary file %s: %s", semanage_filename, str(e.stderr))
                continue
